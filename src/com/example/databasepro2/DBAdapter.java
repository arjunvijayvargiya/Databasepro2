...
public class DBAdapter {
	...
	+ "name text not null, email text not null, member text not null);";
	...
	//---insert a contact into the database---
	public long insertContact(String name, String email,String member)
	{
	...
	KEY_EMAIL,KEY_MEMBER}, null, null, null, null, null);
	}
	...
	KEY_NAME, KEY_EMAIL,KEY_MEMBER}, KEY_ROWID + "=" + rowId, null,
	null, null, null, null);
	if (mCursor != null) {
	mCursor.moveToFirst();
	}
